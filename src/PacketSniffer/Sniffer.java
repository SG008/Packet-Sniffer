...
import static PacketSniffer.Sniffer.output;
...
public class Sniffer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        clear=new java.awt.Button("Clear");
        ...
        output.setFont(new Font("Monospaces",0,12));
    ...
    //--------------------------------------------------
        ...
        //Window.getContentPane().add(SP_Output);
...
//        hexScroll = new javax.swing.JScrollPane();
        ...
        clear.setPreferredSize(new java.awt.Dimension(50, 24));
        filterOptions.setLabel("Clear");
        
        //filterOptions.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "---", "TCP", "UDP", "ICMP" }));
        filterOptions.setPreferredSize(new java.awt.Dimension(220, 24));
...
//                    .addComponent(hexLabel)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(SP_Output, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)   
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(infoLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
//                .addComponent(hexLabel)
                .addGap(1, 1, 1)
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                new Thread(new Runnable(){
                    ...
                    public void run() {
                        ...
                        output.append("\nCapturing on interface "+inputInterfaces[interfaceIndex]+
                                        "\n--------------------------------------------"+
                                        "--------------------------------------------\n\n");
                        while(!stopButton.getModel().isPressed() && captureState == true) {
                            SwingUtilities.invokeLater(new Runnable() {
                                ...
                                @Override
                                public void run() {
                                    output.append(packet.toString()+" Data Length"+packet.data.length+
                                                    "\n-----------------------------------"+
                                                    "-----------------------------------\n\n");
                                    if(packet != null) {
